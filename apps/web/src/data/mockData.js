...
export const mockProducts = [
  {
    ...
    price: 189.99,
    description:
      'Luxurious handwoven wool blanket made from 100% merino wool. Perfect for cozy evenings and adds warmth to any living space.',
    imageUrl:
  ...
  },
  {
    ...
    price: 125.0,
    description:
      "Beautiful set of 6 handcrafted ceramic dinner plates. Each plate is unique with subtle variations that showcase the artisan's skill.",
    imageUrl:
      'https://images.unsplash.com/photo-1571864358655-eda1b38b2549?w=400',
    images: [
  ...
  },
  {
    ...
    price: 67.5,
    description:
      'Exquisite hand-carved wooden bowl made from sustainable bamboo. Perfect for serving salads, fruits, or as a decorative piece.',
  ...
  },
  {
    ...
    price: 45.0,
    description:
      'Intricate macramé wall hanging that adds bohemian charm to any space. Handcrafted using natural cotton cord.',
    imageUrl:
      'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400',
    images: [
      'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=500',
  ...
  },
  {
    ...
    price: 85.0,
    description:
      'Elegant glass pendant necklace featuring hand-blown glass with embedded metallic accents. Each piece is one-of-a-kind.',
    imageUrl:
  ...
  },
  {
    ...
    price: 78.0,
    description:
      'Premium leather journal cover handcrafted from full-grain leather. Features hand-stitched details and ages beautifully over time.',
    imageUrl: 'https://images.unsplash.com/photo-1544966503-7cc5ac882d5e?w=400',
    images: [
      'https://images.unsplash.com/photo-1544966503-7cc5ac882d5e?w=500',
      'https://images.unsplash.com/photo-1544966503-7cc5ac882d5e?w=500',
...
export const mockReviews = [
  {
    ...
    rating: 5,
    comment:
      "Absolutely beautiful blanket! The quality is exceptional and it's so soft and warm. Highly recommend!",
    date: '2025-01-15',
    verified: true,
  },
  {
    ...
    rating: 4,
    comment:
      'Great quality and fast shipping. The colors are exactly as shown in the photos.',
    date: '2025-01-10',
    verified: true,
  },
  {
    ...
    rating: 5,
    comment:
      'These plates are gorgeous! Each one is slightly different which makes them special. Perfect for dinner parties.',
    date: '2025-01-12',
    verified: true,
  },
];
