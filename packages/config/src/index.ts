...
export const seoConfig = {
  ...
  defaultDescription:
    'Discover unique handcrafted goods from talented artisans worldwide. Shop authentic, quality items that tell a story.',
  defaultKeywords:
    'handcrafted, artisan, handmade, unique, crafts, art, pottery, textiles, jewelry',
